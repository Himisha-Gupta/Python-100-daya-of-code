...
def calculate_score(list):
    if 11 in list and 10 in list and len(list) == 2:  # if sum(list) == 21 and len(list)==2
        return 0
...
computer_cards = []
is_game_ended = False
uc1 = user_cards.append(deal_card())
uc2 = user_cards.append(deal_card())
print(f"The user cards are {user_cards}")
cc1 = computer_cards.append(deal_card())
cc2 = computer_cards.append(deal_card())
print(f"The one of the computer cards are {computer_cards}")
...
while not is_game_ended:
    ...
    print(computers_score , computer_cards)
